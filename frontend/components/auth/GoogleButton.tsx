...
export default function GoogleButton({ label }: { label: string }) {
  return (
    <a
      ...
      className="inline-flex w-full items-center justify-center gap-3 h-11 rounded-full bg-black text-white border border-white/15 hover:bg-white/5 hover:border-white/25 transition-colors text-sm font-medium"
    >
      <GoogleIcon />
      {label}
    </a>
...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden>
      ...
      <path
        fill="#4CAF50"
        d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2c-2 1.4-4.5 2.4-7.2 2.4-5.2 0-9.7-3.4-11.3-8l-6.5 5C9.5 39.5 16.2 44 24 44z"
      />
      <path
        fill="#1976D2"
